# (Optional) Challenge 4 - Natural Language to SQL with Semantic Kernel and RAG

 [< Previous Challenge](./Challenge-03.md) - **[Home](../README.md)** - [Next Challenge >](./Challenge-05.md)

## Introduction

You have been impressed with the results and the speed of implementation.

You decided to take it a step further and build an intelligent application to convert natural language queries into SQL statements. The objective is to precisely translate the user's intent into SQL queries that accurately retrieve the necessary data from the database.
